<?php
// ===== Задание 1. Разбиение и объединение ФИО
...
// ===== Задание 3. Определение пола по ФИО
...
// Задание 4. Определение возрастно-полового состава
...
// Задание 5. Идеальный подбор пары
...
function getPerfectPartner($surname, $name, $patronomyc, $array) {
	...
	if ($user_gender === $random_user_gender) { // если пол совпадает
